...
function crearUsuario() {
  ...
  class Usuario {
    constructor(opciones){
      ...
      return `Hola, mi nombre es ${this.nombre}`;//`Hola mi nombre es ` + this.nombre;
    }
  }
}
  return Usuario;
...
invertida += this[i];
 ...
 return invertida;//return this.split("").reverse().join("");
}  
}
...
function crearInstanciaPersona(nombre, apellido, edad, dir) {
 ...
 return nuevaPersona;//return nuevaPersona = new Persona(...)
}
